  ...
  return (
    <div>
      <div className="h-64 relative">
        ...
        {/* Overheating Warning */}
        <div className="absolute top-12 right-12 flex items-center border border-red-300 px-3 py-2 rounded-md bg-white">
          <ThermometerIcon className="text-red-500 mr-2" size={18} />
          <div>
            <span className="text-red-500 font-medium">45°C</span> Overheating Risk
          </div>
        </div>
      </div>
