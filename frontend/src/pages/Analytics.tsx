...
import { TrendingUp, ArrowUp, SunIcon, GaugeIcon, Plus, LightbulbIcon, AlertTriangleIcon, BatteryLowIcon, XIcon } from "lucide-react";
...
import { NotificationCard, SystemNotification } from "../components/graphs/SystemHealth";
...
export default function Analytics() {
  ...
  const insights: SystemNotification[] = [
    {
      id: '1',
      type: 'normal',
      ...
      timestamp: '3:42am',
      date: '22 Oct 2024',
      icon: <LightbulbIcon size={20} className="text-green-500" />
    },
    {
      id: '2',
      type: 'critical',
      ...
      timestamp: '3:42am',
      date: '22 Oct 2024',
      icon: <BatteryLowIcon size={20} className="text-red-500" />
    },
    {
      id: '3',
      type: 'offline',
      ...
      timestamp: '3:42am',
      date: '22 Oct 2024',
      icon: <XIcon size={20} className="text-gray-500" />
    },
    {
      id: '4',
      type: 'warning',
            ...
            <div className="col-span-12 lg:col-span-4 border-l border-gray-200 pl-6">
              ...
              <div className="space-y-3">
                {insights.map((insight) => (
                  <NotificationCard key={insight.id} notification={insight} />
                ))}
              </div>
            </div>
          </div>
